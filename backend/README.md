...
## Project Structure
    ...
    ├── testapiautosetting_125890  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125890`
...
2. Clone this repo and `cd testapiautosetting_125890`
